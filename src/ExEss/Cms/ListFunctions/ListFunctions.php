        ...
        foreach ($allBaseEntities as $baseFatEntityId) {
            ...
            foreach ($list->getCellLinks() as $cellLink) {
                ...
                if (isset($dynamicListRowCell->options->line1)) {
                    $dynamicListRowCell->options->line1 = DataCleaner::clean($dynamicListRowCell->options->line1);
                }

                if (isset($dynamicListRowCell->options->line2)) {
                    $dynamicListRowCell->options->line2 = DataCleaner::clean($dynamicListRowCell->options->line2);
                }

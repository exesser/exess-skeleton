...
use ExEss\Cms\Parser\Resolver\Piece\ContainerMethodPiece;
...
use ExEss\Cms\Parser\Resolver\Piece\LogContextPiece;
...
/**
 * Translates a resolved path piece to a fat entity
 */
class FatEntityTranslator implements PieceTranslatorInterface
{

...
*/
final class Version20210615102232 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE acl_actions (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, category VARCHAR(100) DEFAULT NULL, aclaccess INT DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_6E78FA2CDE12AB56 (created_by), INDEX IDX_6E78FA2CBAA24139 (modified_user_id), INDEX idx_category_name (category, name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE acl_roles (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, code VARCHAR(255) NOT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_32A76378DE12AB56 (created_by), INDEX IDX_32A76378BAA24139 (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dash_menuactions (id CHAR(36) NOT NULL, flw_actions_id_c CHAR(36) DEFAULT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, label_c VARCHAR(100) DEFAULT NULL, sort_order INT DEFAULT NULL, icon_c VARCHAR(100) DEFAULT NULL, params_c JSON DEFAULT NULL, conditionsenabled_c JSON DEFAULT NULL, conditions_hide_c JSON DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_flw_actions_id_29cdc032 (flw_actions_id_c), INDEX fk_users_id_44ee9b96 (created_by), INDEX fk_users_id_b842ba88 (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fltrs_filters (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, default_filters_json_c JSON DEFAULT NULL, filterskey_c VARCHAR(64) DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_0a623723 (modified_user_id), INDEX fk_users_id_6c9c0cd2 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fltrs_fields (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, label_c VARCHAR(255) DEFAULT NULL, operator VARCHAR(6) DEFAULT \'=\', field_key_c VARCHAR(255) DEFAULT NULL, field_sql_c TEXT DEFAULT NULL, field_options_c JSON DEFAULT NULL, field_options_enum_key_c VARCHAR(255) DEFAULT NULL, sort_c VARCHAR(4) DEFAULT \'10\', type_c ENUM(\'bool\', \'checkboxGroup\', \'date\', \'datetime\', \'enum\', \'radioGroup\', \'selectWithSearch\', \'toggleGroup\', \'varchar\') DEFAULT NULL COMMENT \'(DC2Type:enum_filter_field_type)\', date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_d334c340 (modified_user_id), INDEX fk_users_id_82b17b3c (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE find_search (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, link_to ENUM(\'dashboard\', \'focus_mode\', \'guidance_mode\') DEFAULT NULL COMMENT \'(DC2Type:enum_link_to)\', params JSON DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_739bb32e (created_by), INDEX fk_users_id_12ec510a (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE flw_actions (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, guid VARCHAR(255) DEFAULT NULL, json JSON DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_cc8489c9 (created_by), INDEX fk_users_id_244b2f9c (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE flw_guidancefields (id CHAR(36) NOT NULL, flow_action_id CHAR(36) DEFAULT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, field_id TEXT DEFAULT NULL, field_label VARCHAR(255) DEFAULT NULL, field_default TEXT DEFAULT NULL, field_type ENUM(\'InputFieldGroup\', \'LabelAndAction\', \'LabelAndText\', \'LargeTextField\', \'TextField\', \'bestOffer\', \'bool\', \'custom\', \'date\', \'datetime\', \'drawPad\', \'enum\', \'hashtagText\', \'hidden\', \'json\', \'json-editor\', \'selectWithSearch\', \'tariffCalculation\', \'textarea\', \'toggle\', \'upload\', \'wysiwyg\') DEFAULT NULL COMMENT \'(DC2Type:enum_flow_field_type)\', field_generatebyserver TINYINT(1) DEFAULT \'1\', field_module VARCHAR(255) DEFAULT NULL, field_modulefield VARCHAR(255) DEFAULT NULL, field_generatetype ENUM(\'fixed\', \'repeat-trigger\') DEFAULT NULL COMMENT \'(DC2Type:enum_generated_field_type)\', field_hideexpression TEXT DEFAULT NULL, field_disableexpression TEXT DEFAULT NULL, field_multiple TINYINT(1) DEFAULT NULL, field_fieldgroup VARCHAR(255) DEFAULT NULL, field_order INT DEFAULT 100, field_action_json JSON DEFAULT NULL, field_hasborder TINYINT(1) DEFAULT \'1\', field_orientation ENUM(\'header-top\', \'label-left\', \'label-top\') DEFAULT NULL COMMENT \'(DC2Type:enum_field_orientation)\', field_address_type VARCHAR(255) DEFAULT NULL, field_enum_values JSON DEFAULT NULL, field_fieldexpression TEXT DEFAULT NULL, field_upload_validation VARCHAR(255) DEFAULT NULL, field_custom JSON DEFAULT NULL, field_read_only TINYINT(1) DEFAULT \'0\', required_c TINYINT(1) DEFAULT \'0\', field_no_backend_interaction TINYINT(1) DEFAULT \'0\', field_valueexpression TEXT DEFAULT NULL, field_auto_select_suggestions TINYINT(1) DEFAULT \'0\', api_label_c VARCHAR(255) DEFAULT NULL, remove_when_empty TINYINT(1) DEFAULT NULL, field_overwrite_value VARCHAR(1024) DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_69AB02108F1653AA (flow_action_id), INDEX fk_users_id_a2a4c0e6 (created_by), INDEX idx_field_type (field_type), INDEX fk_users_id_1bd9c57c (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE flw_flowsteps (id CHAR(36) NOT NULL, grid_template_id CHAR(36) DEFAULT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, type_c ENUM(\'DEFAULT\') DEFAULT \'DEFAULT\' COMMENT \'(DC2Type:enum_flow_step_type)\', json_fields_c JSON DEFAULT NULL, key_c VARCHAR(150) DEFAULT NULL, is_card_c TINYINT(1) DEFAULT NULL, label_c VARCHAR(150) DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_22D849FD4AAAEE12 (grid_template_id), INDEX fk_users_id_173ce7ba (modified_user_id), INDEX fk_users_id_f1bb7a06 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE grid_gridtemplates (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, key_c VARCHAR(255) DEFAULT NULL, json_fields_c JSON DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_5a0588cb (modified_user_id), INDEX fk_users_id_45b3d681 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE list_dynamic_list (id CHAR(36) NOT NULL, filter_id CHAR(36) DEFAULT NULL, top_bar_id CHAR(36) DEFAULT NULL, external_object_id CHAR(36) DEFAULT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, display_footer TINYINT(1) DEFAULT \'0\', base_object VARCHAR(255) DEFAULT NULL, standard_filter JSON DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, items_per_page INT DEFAULT 10 NOT NULL, default_filter_values JSON DEFAULT NULL, filters_have_changed TINYINT(1) DEFAULT \'0\', combined TINYINT(1) DEFAULT \'0\', responsive TINYINT(1) DEFAULT \'0\' NOT NULL, fix_pagination TINYINT(1) DEFAULT \'1\' NOT NULL, quick_search TINYINT(1) DEFAULT \'0\' NOT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_2F5207E7D395B25E (filter_id), INDEX IDX_2F5207E75F678FB6 (top_bar_id), INDEX IDX_2F5207E7776F93F (external_object_id), INDEX fk_users_id_8ba3dc94 (modified_user_id), INDEX fk_users_id_a0c59bd5 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE list_row_action (id CHAR(36) NOT NULL, flow_action_id CHAR(36) DEFAULT NULL, row_bar_id CHAR(36) DEFAULT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, type ENUM(\'CALLBACK\') DEFAULT \'CALLBACK\' COMMENT \'(DC2Type:enum_action_type)\', icon VARCHAR(255) DEFAULT NULL, action_name VARCHAR(255) DEFAULT NULL, conditionsenabled_c JSON DEFAULT NULL, conditions_hide_c JSON DEFAULT NULL, order_c INT DEFAULT 10, params_c JSON DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX IDX_CDC72B9C8F1653AA (flow_action_id), INDEX IDX_CDC72B9C58BCF6E8 (row_bar_id), INDEX fk_users_id_e9284788 (created_by), INDEX fk_users_id_a5f43d19 (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE list_row_bar (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_31ec3949 (created_by), INDEX fk_users_id_8fd6281b (modified_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE list_sorting_options (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, sort_key VARCHAR(255) DEFAULT NULL, order_by ENUM(\'ASC\', \'DESC\') DEFAULT \'ASC\' COMMENT \'(DC2Type:enum_order)\', date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_34c99210 (modified_user_id), INDEX fk_users_id_50a5c25e (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu_mainmenu (id CHAR(36) NOT NULL, created_by CHAR(36) NOT NULL, modified_user_id CHAR(36) DEFAULT NULL, params_c JSON DEFAULT NULL, display_order_c VARCHAR(255) DEFAULT \'10\', link_c VARCHAR(255) DEFAULT NULL, icon_c VARCHAR(255) DEFAULT NULL, date_entered DATETIME NOT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX fk_users_id_2a84509c (modified_user_id), INDEX fk_users_id_05843a67 (created_by), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fltrs_filters_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, default_filters_json_c JSON DEFAULT NULL, filterskey_c VARCHAR(64) DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fltrs_fields_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, label_c VARCHAR(255) DEFAULT NULL, operator VARCHAR(6) DEFAULT NULL, field_key_c VARCHAR(255) DEFAULT NULL, field_sql_c TEXT DEFAULT NULL, field_options_c JSON DEFAULT NULL, field_options_enum_key_c VARCHAR(255) DEFAULT NULL, sort_c VARCHAR(4) DEFAULT NULL, type_c VARCHAR(255) DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE find_search_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, link_to VARCHAR(255) DEFAULT NULL, params JSON DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE list_row_action_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, flow_action_id CHAR(36) DEFAULT NULL, row_bar_id CHAR(36) DEFAULT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, icon VARCHAR(255) DEFAULT NULL, action_name VARCHAR(255) DEFAULT NULL, conditionsenabled_c JSON DEFAULT NULL, conditions_hide_c JSON DEFAULT NULL, order_c INT DEFAULT NULL, params_c JSON DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu_mainmenu_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, params_c JSON DEFAULT NULL, display_order_c VARCHAR(255) DEFAULT NULL, link_c VARCHAR(255) DEFAULT NULL, icon_c VARCHAR(255) DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE securitygroups_users_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, securitygroup_id CHAR(36) DEFAULT NULL, user_id CHAR(36) DEFAULT NULL, primary_group TINYINT(1) DEFAULT NULL, date_modified DATETIME DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fe_selectwithsearch_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, base_object VARCHAR(255) DEFAULT NULL, filters TEXT DEFAULT NULL, items_on_page INT DEFAULT NULL, order_by VARCHAR(255) DEFAULT NULL, option_label VARCHAR(255) DEFAULT NULL, filter_string VARCHAR(255) DEFAULT NULL, option_key VARCHAR(255) DEFAULT NULL, needs_query TINYINT(1) DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE trans_translation_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, created_by CHAR(36) DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, locale VARCHAR(255) DEFAULT NULL, translation TEXT DEFAULT NULL, domain VARCHAR(255) DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, user_name VARCHAR(60) DEFAULT NULL, user_hash VARCHAR(255) DEFAULT NULL, salt VARCHAR(40) DEFAULT NULL, system_generated_password TINYINT(1) DEFAULT NULL, pwd_last_changed DATETIME DEFAULT NULL, sugar_login TINYINT(1) DEFAULT NULL, first_name VARCHAR(30) DEFAULT NULL, last_name VARCHAR(30) DEFAULT NULL, external_auth_only TINYINT(1) DEFAULT NULL, description TEXT DEFAULT NULL, date_entered DATETIME DEFAULT NULL, date_modified DATETIME DEFAULT NULL, modified_user_id CHAR(36) DEFAULT NULL, created_by CHAR(36) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, portal_only TINYINT(1) DEFAULT NULL, employee_status VARCHAR(100) DEFAULT NULL, is_group TINYINT(1) DEFAULT NULL, selfcare_toc TINYINT(1) DEFAULT NULL, preferred_locale VARCHAR(255) DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_guidance_recovery_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, recovery_data JSON DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_login_aud (audit_timestamp DATETIME(6) NOT NULL COMMENT \'(DC2Type:datetime_immutable_microseconds)\', audit_operation ENUM(\'DELETE\', \'INSERT\', \'UPDATE\') NOT NULL COMMENT \'(DC2Type:enum_audit_operation)\', id CHAR(36) NOT NULL, last_login DATETIME DEFAULT NULL, jwt TEXT DEFAULT NULL, INDEX idx_operation_id (audit_operation, id), PRIMARY KEY(audit_timestamp, id, audit_operation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
